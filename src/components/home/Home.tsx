...
import { ArrowCompo } from "../exercises/carousel/Arrow";
         ...
         <div className="flex flex-col w-full h-full bg-gray-300">
           ...
           <div className="m-4">
             ...
             <div
               ...
               `}
             >
               <span className="text-white text-center text-4xl">Place Holder</span>
               <div className="block bg-blue-700 text-white">
                 <ArrowCompo direction="left" handleClick={() => {}} />
               </div>
             </div>
           </div>
